...
tgt_models=("mrm8488/codebert-base-finetuned-detect-insecure-code" "claudios/VulBERTa-MLP-ReVeal" "claudios/VulBERTa-MLP-D2A" "claudios/VulBERTa-MLP-Draper")
...
do
    ...
    do
        ...
        echo "python test.py --max_iter $max_iter --top_k $top_k --tgt_model $tgt_model --test_dataset Zaib/java-vulnerability --data_lang java --attack $atk $params" >> "$output_file"
...
do
    ...
    do
        params=${atk_params_map[$atk]}
        echo "python test.py --max_iter $max_iter --top_k $top_k --tgt_model $tgt_model --test_dataset google/code_x_glue_cc_defect_detection --data_lang c --attack $atk $params" >> "$output_file"
